...
{
    w = "(profilenamespace getvariable [""IGUI_GRID_CHAT_W"", (20 *(((safezoneW / safezoneH) min 1.2) / 40))]) * (parseNumber (missionNamespace getVariable ['grad_minui_chat_enabled',true]))";
};
